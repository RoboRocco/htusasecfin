...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/htusa-sec-fin)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/htusa-sec-fin
```

A live public deployment of this template is available at [https://htusa-sec-fin.templates.workers.dev](https://htusa-sec-fin.templates.workers.dev)
